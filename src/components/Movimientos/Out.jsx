...
export const Out = ({switchOutHandler }) => {
    ...
    const handleOutSubmit = (e) => {
        e.preventDefault();
        registrarMovimientoSalida(formState.productId.value, formState.quantity.value, formState.reason.value, formState.destiny.value);
    };
              ...
              <Stack spacing={4}>
                ...
                <form onSubmit={handleOutSubmit}>
                  <VStack spacing={4}>
                    ...
                    <FormControl>
                      <FormLabel color={labelColor}>reason</FormLabel>
                      <Input
                        type="text"
                    ...
                    <FormControl>
                        <FormLabel color={labelColor}>destiny</FormLabel>
                        <Input
                            type="text"
